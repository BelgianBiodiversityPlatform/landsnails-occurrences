...
write.csv(occurrence, "C:\\Users\\WARD\\OneDrive - UGent\\School\\1ste master\\sem_2\\Project\\landsnails-occurrences\\data\\processed\\occurence.csv", append = FALSE, na = "",  row.names = FALSE, fileEncoding = "UTF-8")
```
