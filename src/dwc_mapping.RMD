...
```{r}
occurrence %<>% mutate(dwc_language = "my_language") # e.g. "en"
```

### license

```{r}
occurrence %<>% mutate(dwc_license = "my_license") # e.g. "http://creativecommons.org/publicdomain/zero/1.0/"
```
...
```{r}
occurrence %<>% mutate(dwc_datasetName = "my_dataset_title") # e.g. "Checklist of non-native freshwater fishes in Flanders, Belgium"
```
