...
input_data %<>% left_join(
  ...
  by = c("verbatimScientificName" = "scientificname"))
...
```{r}
occurrence %<>% mutate(institutionCode = "my_institution_code") # e.g. "INBO"
```
...
#occurence %<>% rename(scientificName = scientificname)
```
